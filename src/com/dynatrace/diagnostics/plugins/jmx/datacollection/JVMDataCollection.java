...
public class JVMDataCollection {

	private static final Logger log = Logger.getLogger(JVMDataCollection.class.getName());
	private ArrayList<JVMStats> test;
	
	public JVMDataCollection(ArrayList<JVMStats> test){
        this.test = test;
	}
    ...
    public ArrayList<JVMStats> doBean(MBeanServerConnection mbsc, ObjectInstance instance, String[] attributes, String BeanName)
            throws Exception {
    ...
    public ArrayList<JVMStats> execute(MBeanServerConnection mbsc, String[] MBeans, String[] attributes)
            throws Exception {
