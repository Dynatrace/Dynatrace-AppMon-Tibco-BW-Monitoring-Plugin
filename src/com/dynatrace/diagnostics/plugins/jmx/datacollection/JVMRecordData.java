...
import com.dynatrace.diagnostics.plugins.jmx.variableholder.JVMStats;
	...
	public class JVMRecordData implements JvmMonitoringConstants{

		private static final Logger log = Logger.getLogger(JVMRecordData.class.getName());
	    
	    public void getWriteToDB(MonitorEnvironment envs, String Server, String Environment, ArrayList<JVMStats> ad, ArrayList<JVMStats> oldCopy) throws Exception {
	        String measureName;
	        DynamicMeasure testing = new DynamicMeasure();
	        int i=2;
	        try {
	            ArrayList<JVMStats> list = ad;
	            for (JVMStats fromStatic : list) {
	                ...
	                if(MBean.contains("GarbageCollector") && Attribute.contains("CollectionTime")){
	                	...
	                	if(i==1){
	                		...
	                		if(oldCopy != null){
	                			for (JVMStats fromOldStatic : oldCopy) {
